...
function properties(event) {
    if (event.keyCode == 32)    // space rotation
        ...
        else if (event.keyCode == 119) // w +width
            geometry = new THREE.BoxGeometry( ++width, height, depth, widthSegments, heightSegments, depthSegments );
        else if (event.keyCode == 101) // e -width
            geometry = new THREE.BoxGeometry( --width, height, depth, widthSegments, heightSegments, depthSegments );
    

        else if (event.keyCode == 114) // r +heiht
            geometry = new THREE.BoxGeometry( width, ++height, depth, widthSegments, heightSegments, depthSegments );
        else if (event.keyCode == 116) // t -height
            geometry = new THREE.BoxGeometry( width, --height, depth, widthSegments, heightSegments, depthSegments );
    

        else if (event.keyCode == 121) // y +depth
            geometry = new THREE.BoxGeometry( width, height, ++depth, widthSegments, heightSegments, depthSegments );
        else if (event.keyCode == 117) // u -depth
            geometry = new THREE.BoxGeometry( width, height, --depth, widthSegments, heightSegments, depthSegments );
        

        else if (event.keyCode == 115) // s +widthSegment
            geometry = new THREE.BoxGeometry( width, height, depth, ++widthSegments, heightSegments, depthSegments );
        else if (event.keyCode == 100) // d -widthSegment
            geometry = new THREE.BoxGeometry( width, height, depth, --widthSegments, heightSegments, depthSegments );
    

        else if (event.keyCode == 102) // f +heihtSegment
            geometry = new THREE.BoxGeometry( width, height, depth, widthSegments, ++heightSegments, depthSegments );
        else if (event.keyCode == 103) // g -heightSegment
            geometry = new THREE.BoxGeometry( width, height, depth, widthSegments, --heightSegments, depthSegments );
    

        else if (event.keyCode == 104) // h +depthSegment
            geometry = new THREE.BoxGeometry( width, height, depth, widthSegments, heightSegments, ++depthSegments );
        else if (event.keyCode == 106) // j -depthSegment
            geometry = new THREE.BoxGeometry( width, height, depth, widthSegments, heightSegments, --depthSegments );
