...
function properties(event) {
    if (event.keyCode == 32)    // space rotation
        ...
        else if (event.keyCode == 119) // w +innerRadius
            geometry = new THREE.RingGeometry(++innerRadius, outerRadius, thetaSegments, phiSegments, thetaStart, thetaLength);
        else if (event.keyCode == 101) // e -innerRadius
            geometry = new THREE.RingGeometry(--innerRadius, outerRadius, thetaSegments, phiSegments, thetaStart, thetaLength);

        else if (event.keyCode == 99) // c +outerRadius
            geometry = new THREE.RingGeometry(innerRadius, ++outerRadius, thetaSegments, phiSegments, thetaStart, thetaLength);
        else if (event.keyCode == 118) // v -outerRadius
            geometry = new THREE.RingGeometry(innerRadius, --outerRadius, thetaSegments, phiSegments, thetaStart, thetaLength);

        else if (event.keyCode == 121) // y +thetaSegments
            geometry = new THREE.RingGeometry(innerRadius, outerRadius, ++thetaSegments, phiSegments, thetaStart, thetaLength);
        else if (event.keyCode == 117) // u -thetaSegments
            geometry = new THREE.RingGeometry(innerRadius, outerRadius, --thetaSegments, phiSegments, thetaStart, thetaLength);
        
        else if (event.keyCode == 115) // s +phiSegments
            geometry = new THREE.RingGeometry(innerRadius, outerRadius, thetaSegments, ++phiSegments, thetaStart, thetaLength);
        else if (event.keyCode == 100) // d -phiSegments
            geometry = new THREE.RingGeometry(innerRadius, outerRadius, thetaSegments, --phiSegments, thetaStart, thetaLength);
