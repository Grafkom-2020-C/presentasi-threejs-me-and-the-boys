...
function properties(event) {
    if (event.keyCode == 32)    // space rotation
        ...
        if (event.keyCode == 97){   // a line
            ...
            geometry = new THREE.CylinderGeometry(radiusTop, radiusBottom, height, radialSegments, heightSegments, openEnded = !openEnded, thetaStart, thetaLength);
            ...
            geometry = new THREE.CylinderGeometry(radiusTop, radiusBottom, height, radialSegments, heightSegments, openEnded, thetaStart += 0.05, thetaLength);
        else if (event.keyCode == 100) // d -thetaStart
            geometry = new THREE.CylinderGeometry(radiusTop, radiusBottom, height, radialSegments, heightSegments, openEnded, thetaStart -= 0.05, thetaLength);
    

        else if (event.keyCode == 102) // f +thetaLength
            geometry = new THREE.CylinderGeometry(radiusTop, radiusBottom, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength += 0.05);
