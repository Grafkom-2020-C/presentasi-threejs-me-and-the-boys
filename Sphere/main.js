...
function properties(event) {
    if (event.keyCode == 32)    // space rotation
        ...
        else if (event.keyCode == 99) // c + widthSegments
            geometry = new THREE.SphereGeometry(radius , ++widthSegments, heightSegments, phiStart, phiLength, thetaStart, thetaLength);
        else if (event.keyCode == 118) // v -widthSegments
            geometry = new THREE.SphereGeometry(radius , --widthSegments, heightSegments, phiStart, phiLength, thetaStart, thetaLength);

        else if (event.keyCode == 114) // r +heightSegments
            geometry = new THREE.SphereGeometry(radius , widthSegments, ++heightSegments, phiStart, phiLength, thetaStart, thetaLength);
        else if (event.keyCode == 116) // t -heightSegments
            geometry = new THREE.SphereGeometry(radius , widthSegments, --heightSegments, phiStart, phiLength, thetaStart, thetaLength);
